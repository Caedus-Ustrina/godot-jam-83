...
func _on_area_2d_area_entered(area: Area2D) -> void:  #emitting the signal from global file named "signals"
		Signals.emit_signal("DamageAmount")
		queue_free()
